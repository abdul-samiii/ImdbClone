    ...
    <div className='lg:ml-[40%] md:ml-[25%]'>
      ...
      <div className='flex space-x-2 mx-2 mt-14'>
        ...
        <div className='space-y-2'>
          ...
          <h2 className='text-white font-bold text-lg bg-[#363232] w-52 text-center p-2 rounded-sm hover:scale-105  transition duration-300 ease-in-out cursor-pointer'><Link to='/addmovieimages'>Upload Movie Images</Link></h2>
        </div>
      </div>
