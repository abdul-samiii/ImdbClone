...
const Explore = () => {
  ...
  return (
    <div>
      <h1 className='text-[#E0B416] text-3xl font-extrabold lg:ml-[17%] ml-2 mt-12'>Explore Movies & TV Shows (THIS SECTION IS HARDCODED)</h1>
      ...
      <div className='grid md:grid-cols-2 grid-cols-1 md:w-[70%] lg:w-[50%] lg:ml-[10%]'>
        {
          FreeTrailerData.map((trailer, index) => (
            <div className='flex lg:ml-[24.5%] ml-2 mt-4 hover:bg-[#1A1A1A] cursor-pointer p-2 rounded-md px-4'>
              <p className='text-white my-auto border-r-2  border-[#E0B416] pr-2'>{index + 1}</p>
              ...
              <div className='mt-1 '>
                ...
                <p className='text-white'>{trailer?.earning}</p>
              </div>
            </div>
          ))
        }
